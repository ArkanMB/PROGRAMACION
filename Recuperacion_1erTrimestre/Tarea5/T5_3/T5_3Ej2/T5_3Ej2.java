...
public class T5_3Ej2 {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("%-4s %-20s %-7s", "", "Instrucción", "");
    System.out.println();

    a = (entero1 > 5) && (entero2 + 3 < 10);
    System.out.printf("%-4s %-20s %-7s", "A)", "a = b", a);
    System.out.println();

    b = (10 != entero1 + 5) || (20 > (entero2 + 5) * entero1 + 5);
    System.out.printf("%-4s %-20s %-7s", "B)", "c = a", b);
    System.out.println();

    c = entero1 * entero2 + 10 + 4/2 - 2*4 +2;
    System.out.printf("%-4s %-20s %-7s", "C)", "c = a", c);
    System.out.println();

    d = (10/2 - 1 == entero1) && (20 > entero2 + 13);
    System.out.printf("%-4s %-20s %-7s", "D)", "c = a", d);
    System.out.println();

    e = (5-2 > 4) &&! (5 == 25/5);
    System.out.printf("%-4s %-20s %-7s", "E)", "c = a", e);
    System.out.println();

    f = "J"=="j" || "S"=="s"; 
    System.out.printf("%-4s %-20s %-7s", "F)", "c = a", f);
    System.out.println();

    g = (4*2 <= 8) || (2*2 < 5) && (4 > 3 + 1);
    System.out.printf("%-4s %-20s %-7s", "G)", "c = a", g);
    System.out.println();

    h = (10+4 < 15-3) || (2*5 + 1 > 14 - 2*2);
    System.out.printf("%-4s %-20s %-7s", "H)", "c = a", h);
    System.out.println("\n");
